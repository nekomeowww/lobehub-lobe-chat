    ...
    },
    {
      ...
      parameters: zodToJsonSchema(
        object({
          ...
          description: string().optional().describe('Detailed description of the context storyline.'),
          extractedLabels: any()
            .optional()
          ...
          type: string()
            .optional()
            .describe('High level context classification such as project, relationship, health, etc.'),
          userMemoryIds: array(string())
            .nonempty()
            .describe('List of memory IDs that belong to this context (must all belong to the same user).'),
        }),
      ) as PluginSchema,
    },
    {
      ...
      parameters: zodToJsonSchema(
        object({
          conclusionDirectives: string()
            .optional()
            .describe('Self-contained directive summarizing the preference for assistant behavior.'),
          extractedLabels: any()
            .optional()
            .describe('Model extracted preference labels or traits.'),
          extractedScopes: any()
            .optional()
            .describe('JSON structure describing the scope or situations where the preference applies.'),
          scorePriority: number()
            .optional()
            .describe('Numeric priority score reflecting how critical it is to honor this preference.'),
          suggestions: string()
            .optional()
            .describe('Optional assistant suggestions or follow-up actions derived from this preference.'),
          type: string()
            .optional()
            .describe('High level preference classification such as lifestyle, communication, or productivity.'),
        }),
      ) as PluginSchema,
    },
  ],
